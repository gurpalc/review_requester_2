      ...
      switch (key) {
        ...
        case 'business_id':
          result.businessId = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String;
          break;
        case 'number_requests':
          result.numberRequests = serializers.deserialize(value,
...
class _$UsersRecord extends UsersRecord {
  ...
  bool operator ==(Object other) {
    ...
    return other is UsersRecord &&
        ...
        numberRequests == other.numberRequests &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper('UsersRecord')
          ...
          ..add('numberRequests', numberRequests)
...
class UsersRecordBuilder implements Builder<UsersRecord, UsersRecordBuilder> {
  ...
  int _numberRequests;
  int get numberRequests => _$this._numberRequests;
  set numberRequests(int numberRequests) =>
      _$this._numberRequests = numberRequests;

  bool _solicited;
  bool get solicited => _$this._solicited;
  set solicited(bool solicited) => _$this._solicited = solicited;
  ...
  UsersRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _numberRequests = $v.numberRequests;
